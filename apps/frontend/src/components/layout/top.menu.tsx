...
export const useMenuItem = () => {
  ...
  const firstMenu = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M8 2V4M16 2V4M3 10H21M5 4H19C20.1046 4 21 4.89543 21 6V20C21 21.1046 20.1046 22 19 22H5C3.89543 22 3 21.1046 3 20V6C3 4.89543 3.89543 4 5 4Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M7.5 3.83333L8.66667 7.33333L12.1667 8.5L8.66667 9.66667L7.5 13.1667L6.33333 9.66667L2.83333 8.5L6.33333 7.33333L7.5 3.83333Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M14.1667 10.5L15 13L17.5 13.8333L15 14.6667L14.1667 17.1667L13.3333 14.6667L10.8333 13.8333L13.3333 13L14.1667 10.5Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  const secondMenu = [
    ...
    },
    {
      ...
      path: 'https://affiliate.contentflow.com',
      role: ['ADMIN', 'SUPERADMIN', 'USER'],
      requireBilling: true,
    },
    {
