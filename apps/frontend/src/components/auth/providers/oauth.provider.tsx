...
export const OauthProvider = () => {
  ...
  return (
    <div
      onClick={gotoLogin}
      className={`cursor-pointer flex-1 bg-white border border-newBorder h-[44px] rounded-[10px] flex justify-center items-center text-customColor16 gap-[4px] hover:bg-cf-offwhite transition`}
    >
      <div>
        <SafeImage
