    ...
    <div ref={ref} className="relative">
      <div
        ...
        className={clsx(
          ...
          currentDelay > 0 && 'bg-[#8a3f08] text-white rounded-full'
        )}
      >
        <DelayIcon />
      </div>
            ...
            {delayOptions.map((option) => (
              <div
                ...
                className={clsx(
                  ...
                  currentDelay === option.value && 'bg-[#b4530a] text-white hover:bg-[#b4530a]'
                )}
              >
                {option.label}
              </div>
          ...
          <div className="border-t border-newTextColor/10 mt-[8px] pt-[8px]">
            <div className="flex gap-[4px]">
              <input
                ...
                className={clsx(
                  'flex-1 w-full h-[32px] px-[8px] rounded-[4px] bg-newBgColor border text-[13px] outline-none focus:border-[#b4530a]',
                  isCustomDelay ? 'border-[#b4530a]' : 'border-newTextColor/10'
                )}
              />
              <button
                onClick={(e) => {
                ...
                className="h-[32px] px-[10px] rounded-[4px] bg-[#b4530a] text-white text-[12px] font-[600] hover:bg-[#b4530a]/80"
              >
                Set
              </button>
            </div>
