    ...
    <div className="relative w-full max-w-[400px] mx-auto">
      ...
      <div className="bg-newBgColorInner rounded-[12px] p-[20px] border border-newTableBorder">
        <div className="text-[15px] font-semibold mb-[16px] flex items-center gap-[8px]">
          <DelayIcon size={18} className="text-[#b4530a]" />
        ...
        <div className="flex gap-[12px] items-end">
          ...
          <button
            type="button"
            onClick={addHour}
            className="h-[42px] px-[16px] bg-[#b4530a] hover:bg-[#7640e0] transition-colors rounded-[8px] flex items-center gap-[6px] text-white text-[14px] font-medium"
          >
            <PlusIcon size={14} />
            {t('add', 'Add')}
          </button>
            ...
            {times.map((timeSlot, index) => (
              <div
                ...
                className={clsx(
                  ...
                  'hover:border-[#b4530a]/40 transition-colors'
                )}
              >
                <div className="flex items-center gap-[12px]">
                  <div className="w-[8px] h-[8px] rounded-full bg-[#b4530a]" />
