    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The ContentFlow browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
      <div className="flex gap-[10px]">
        <Button
          ...
          onClick={() => {
            window.open(
              'https://chromewebstore.google.com/detail/contentflow/cidhffagahknaeodkplfbcpfeielnkjl?hl=en',
              '_blank'
            );
            modals.closeCurrent();
          }}
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          ContentFlow does not take responsibility for any issues arising or account
    ...
    (
      ...
      async () => {
        ...
        const gotoIntegration = async (externalUrl?: string) => {
          ...
          // carry the `contentflow://` deep link so the backend redirects
          ...
          const params = [
            ...
            onboardingParam,
            isMobile
              ? `redirectUrl=${encodeURIComponent('contentflow://integrations')}`
              : '',
          ]
            .filter(Boolean)
            .join('&');
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'ContentFlow browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
